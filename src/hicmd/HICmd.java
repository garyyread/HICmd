...
//        openFile.setIcon(getImageIcon("/hicmd/img/ic_action_collection.png"));
//        openFile.setToolTipText("Open File...");
//
//        JMenu help = new JMenu();
//        help.setIcon(getImageIcon("/hicmd/img/ic_action_help.png"));
//        help.setToolTipText("Help");
//
//        JMenu settings = new JMenu();
//        settings.setIcon(getImageIcon("/hicmd/img/ic_action_settings.png"));
//        settings.setToolTipText("Settings");
//
//        JMenu run = new JMenu();
//        run.setIcon(getImageIcon("/hicmd/img/ic_action_play_over_video.png"));
//        run.setToolTipText("Save & Run...");
//
//        JMenu save = new JMenu();
//        save.setIcon(getImageIcon("/hicmd/img/ic_action_save.png"));
